...
$string['uploadnote'] = '<strong>Note :</strong> Seuls les fichiers au format mp3, wma ou wav peuvent être téléchargés';
...
$string['filetypeerror'] = 'Seules les extensions mp3, wma or wav sont supportées. Merci de réessayer.';
