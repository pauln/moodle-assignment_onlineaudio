...
$url = new moodle_url('/mod/assignment/type/onlineaudio/upload.php', array('contextid'=>$contextid,
...
$instance = new assignment_onlineaudio($cm->id, $assignment, $cm, $course);
$submission = $instance->get_submission($formdata->userid, true);

$filemanager_options = array('subdirs'=>0, 'maxbytes'=>$assignment->maxbytes, 'maxfiles'=>-1, 'accepted_types'=>array('*.mp3', '*.wma', '*.wav'), 'return_types'=>FILE_INTERNAL);

    $mform = new mod_assignment_onlineaudio_form(null, array('contextid'=>$contextid, 'userid'=>$formdata->userid, 'options'=>$filemanager_options));
